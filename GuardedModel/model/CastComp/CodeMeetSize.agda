...
descMeetSize (CodeModule.CArg c D1 cB' reflp) (CodeModule.CArg c₁ D2 cB'' reflp) lto ltI ltB lt
  = ≤o-sucMono (omax-mono
    (omax-sucMono (omax-mono (omax∞-mono ltB ≤⨟ omax∞-distR)
      ...
      ≤⨟ omax-swap4)) (omax-mono
    ((≤o-limiting {{æ = Approx}} _ λ k → ≤o-cocone {{æ = Approx}} _ _ (≤o-cocone {{æ = Approx}} _ _ (omax∞-mono (_ ⊓Size _ By hide) ≤⨟ omax∞-distR))) ≤⨟ omax-lim2L _ _) --((≤o-limiting {{æ = Approx}} _ λ k → ≤o-cocone {{æ = Approx}} _ _ (≤o-cocone {{æ = Approx}} _ _ (omax∞-mono (_ ⊓Size _ By hide) ≤⨟ omax∞-distR))) ≤⨟ omax-lim2L _ _)
    (descMeetSize _ _ _ _ _ _ ))
    ≤⨟ omax-swap6)
...
descMeetSize (CodeModule.CHRec c j D1 cB' reflp) (CodeModule.CHRec c₁ j₁ D2 cB'' reflp) lto ltI ltB lt
  ...
  --   --   ((≤o-limiting {{æ = Approx}} _ λ k → ≤o-cocone {{æ = Approx}} _ _ (≤o-cocone {{æ = Approx}} _ _ (omax∞-mono (_ ⊓Size _ By hide) ≤⨟ omax∞-distR)) ) ≤⨟ omax-lim2L _ _ ) ≤⨟ omax-swap4))
  --   (omax-mono
  --     ((≤o-limiting {{æ = Approx}} _ λ k → ≤o-cocone ⦃ æ = Approx ⦄ _ _ (≤o-cocone ⦃ æ = Approx ⦄ _ _ (omax∞-mono (_ ⊓Size _ By hide) ≤⨟ omax∞-distR))) ≤⨟ omax-lim2L _ _)
  --     (descMeetSize D1 D2 lto ltI ltB _))
  --   ≤⨟ omax-swap6) ≤⨟ omax-sucMono (≤o-refl _)
