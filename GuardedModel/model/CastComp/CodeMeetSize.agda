...
open import CastComp.CodeMeet {{dt}} {{dg}} {{ic}}  (⁇Allowed) {ℓ} cSize vSize scm
...
codeMeetSize c1 c2 (H℧L reflp) eq1 eq2 reflp reflp = codeMaxSuc {c1 = c1} {c2 = c2}
codeMeetSize c1 c2 (H℧R reflp) eq1 eq2 reflp reflp = codeMaxSuc {c1 = c1} {c2 = c2}
codeMeetSize c1 c2 (H⁇L reflp x₁) eq1 eq2 reflp reflp = smax-≤R
codeMeetSize c1 c2 (H⁇R reflp) eq1 eq2 reflp reflp = smax-≤L
codeMeetSize c1 c2 (HNeq x) eq1 eq2 reflp reflp = codeMaxSuc {c1 = c1} {c2 = c2}
...
codeMeetSize (CodeModule.Cμ tyCtor c1 D x) (CodeModule.Cμ tyCtor₁ c2 D₁ x₁) (HEq {h1 = HCtor x₂} reflp) reflp reflp reflp reflp
  = ≤ₛ-sucMono (smax-mono ( (_ ⊓Size _ By hide) ) ( (extDLim tyCtor _ _ (λ d → descMeetSize (D d) (D₁ d) _ _ _ _ ≤⨟ DLim-cocone tyCtor _ d) ≤⨟ smax-DLim2 _ _ _ ) ) ≤⨟ smax-swap4)
  ≤⨟ smax-sucMono (≤ₛ-refl )
codeMeetSize (CCumul ⦃ suc< ⦄ c1) (CCumul {{suc<}} c2) (HEq {h1 = .HCumul} reflp) reflp reflp reflp reflp
  = ≤ₛ-sucMono (oCodeMeetSize self-1 c1 c2 reflp reflp)
  ≤⨟ smax-sucMono (≤ₛ-refl)
