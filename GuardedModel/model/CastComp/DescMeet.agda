...
-- --                 (ltB ≤⨟ ltB12)
-- --                 (omax-≤R ≤⨟ ltB12 )) lto  })
-- --         ltcB = omax-mono (omax-≤R ≤⨟ omax-≤R ≤⨟ ≤↑ _) (omax-≤R ≤⨟ omax-≤R ≤⨟ ≤↑ _)
-- --             ≤⨟ ?
-- --         ltCone1 : ∀ cb → omax∞ (codeSize (c1 (cb1 cb))) ≤o
-- --                            O↑
-- --                            (omax (codeSize (CΣ cB1 c1))
-- --                             (omax (OLim {{æ = Approx}} cB1 (λ b → omax∞ (codeSize (c1 b)))) (descSize D1)))
-- --         ltCone1 cb = (≤o-cocone ⦃ æ = Approx ⦄ _ (cb1 cb) (≤o-refl _) ≤⨟ omax-≤L ≤⨟ omax-≤R ≤⨟ ≤↑ _)
-- --         ltCone2 : ∀ cb → omax∞ (codeSize (c2 (cb2 cb))) ≤o
-- --                            O↑
-- --                            (omax (codeSize (CΣ cB2 c2))
-- --                             (omax (OLim {{æ = Approx}} cB2 (λ b → omax∞ (codeSize (c2 b)))) (descSize D2)))
-- --         ltCone2 cb = (≤o-cocone ⦃ æ = Approx ⦄ _ (cb2 cb) (≤o-refl _) ≤⨟ omax-≤L ≤⨟ omax-≤R ≤⨟ ≤↑ _)
-- --         cRet : ApproxEl cB → ℂ ℓ
-- --         cRet cb = c1 (cb1 cb) ⊓ c2 (cb2 cb)
-- --           By hide {arg = ≤∘<-in-< (omax-mono (omax∞-self _ ≤⨟ ltCone1 cb) (omax∞-self _ ≤⨟ ltCone2 cb) ≤⨟ lt) lto }
