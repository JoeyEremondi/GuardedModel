...
descMeet {I1 = I1} {I2 = I2} (CRec j1 D1) (CRec j2 D2) lto ltI ltB lt  =
      CRec
        ...
        (descMeet D1 D2 lto ltI ltB (omax-mono (omax-≤L ≤⨟ ≤↑ _) (omax-≤L ≤⨟ ≤↑ _) ≤⨟ lt))
descMeet {I1 = I1} {I2} {cB1 = cB1} {cB2 = cB2} {cBTarget = cB} {oTop = oTop} (CHRec c1 j1 D1 _ reflp) (CHRec c2 j2 D2 _ reflp) lto ltI ltB lt  =
      ...
      where
        ...
        ltB12 :  omax  (codeSize cB1)  (codeSize cB2) ≤o omax∞ oTop
        ltB12 = omax-mono
          (≤↑ _ ≤⨟ ≤o-sucMono (omax∞-self _ ≤⨟ omax-≤L ≤⨟ ≤↑ _ ≤⨟ omax-≤L ≤⨟ omax-≤L))
          (≤↑ _ ≤⨟ ≤o-sucMono (omax∞-self _ ≤⨟ omax-≤L ≤⨟ ≤↑ _ ≤⨟ omax-≤L ≤⨟ omax-≤L))
          ≤⨟ lt
        --       (≤↑ _ ≤⨟ ≤o-sucMono ((≤↑ _ ≤⨟ ≤o-sucMono (omax∞-self _ ≤⨟ {!!})) ≤⨟ omax-≤L))
        --       (≤↑ _ ≤⨟ ≤o-sucMono ((≤↑ _ ≤⨟ ≤o-sucMono (omax∞-self _ ≤⨟ {!!})) ≤⨟ omax-≤L))
        --        ≤⨟ {!!}
        cb1 : _ → _
        cb1 cb = fromL ([ Approx ]⟨ cB1 ⇐ cB ⟩ cb
        ...
        cRet cb = c1 (cb1 cb) ⊓ c2 (cb2 cb)
          By hide {arg = ≤∘<-in-< (omax-mono
              (≤↑ _ ≤⨟ ≤o-sucMono (((≤↑ _ ≤⨟ ≤o-sucMono (≤o-cocone ⦃ æ = Approx ⦄ _ (cb1 cb) (omax∞-self _) ≤⨟ omax-≤R)) ≤⨟ omax-≤L) ≤⨟ omax-≤L))
              (≤↑ _ ≤⨟ ≤o-sucMono (((≤↑ _ ≤⨟ ≤o-sucMono (≤o-cocone ⦃ æ = Approx ⦄ _ (cb2 cb) (omax∞-self _) ≤⨟ omax-≤R)) ≤⨟ omax-≤L) ≤⨟ omax-≤L))
            ≤⨟ lt) lto }
        k12 : ∀ cb → ApproxEl (cRet cb) → ApproxEl (c1 (cb1 cb)) × ApproxEl (c2 (cb2 cb))
        k12 cb k = fromL ([ Approx ]⟨ (c1 (cb1 cb)) , (c2 (cb2 cb)) ⇐⊓⟩ k
          By hide {arg = ≤∘<-in-< (omax-mono
            (≤o-cocone ⦃ æ = Approx ⦄ _ (cb1 cb) (≤o-refl _) ≤⨟ omax-≤R ≤⨟ omax-≤L ≤⨟ ≤↑ _)
            (≤o-cocone ⦃ æ = Approx ⦄ _ (cb2 cb) (≤o-refl _) ≤⨟ omax-≤R ≤⨟ omax-≤L ≤⨟ ≤↑ _)
            ≤⨟ lt) lto})
