...
So while \lang cannot simulatneously have all three fire-triangle properties,
it can have all of the properties we actually want:
...
GDTL proved decidability of type checking using hereditary substiuttion, which does not
...
While a syntactic model was used, the $GCIC^{\mathcal{G}}$ that embeds CIC and has the gradual guarantees
...
\je{TODO: talk about consistency}
