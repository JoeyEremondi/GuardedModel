...
\subsubsection{Weak Graduality}
        ...
        \je{TODO: should we cut all this and just to EP-pairs? We'll see how complicated everything else is}
        ...
        \begin{definition}[The Gradual Termination Guarantee]
        ...
        In essence, the termination guarantee says that the termination behavior of a term
        ...
        \begin{definition}[Weak Graduality]
      ...
      \end{definition}
        ...
        The proof of weak graduality is obtained using a logical-relations style proof,
...
fragment of CIC and avoid cumulativity, \je{TODO do we?}, so the main difference is
...
\je{TODO: do we need this, if we have the back-translation?}

The translation itself works like the discrete model of GCIC~\citep{bertrand:gcic},
...
in non-dependent cases. \je{TODO explain more?}



\subsubsection{Guarded Type Theory and Non-Positive Types}
...
With this, we have (nearly) enough to model $\gqm$ exactly as a guarded recursive type:\\
...
\Citet{10.1016/j.entcs.2015.12.020} describe how to do this with a guarded ``lifting monad''
...
guarded theories.
\je{TODO: other guarded theories? Check}
...
\je{TODO: check this, this is the idea but might not be exactly how El is defined}
