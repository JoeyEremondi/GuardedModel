...
descMeetSize (CodeModule.CArg c ar1 D1 cB' reflp) (CodeModule.CArg c₁ ar2 D2 cB'' reflp) lto ltB lt
  = ≤ₛ-sucMono
    ...
    ≤⨟ smax-sucMono ≤ₛ-refl
  -- ≤ₛ-sucMono (smax*-mono (
  --   smax-sucMono (smax-mono ltB ((≤ₛ-limiting   λ k → _ ⊓Size _ By hide
  --     ≤⨟ ≤ₛ-cocone  _
  --     ≤⨟ ≤ₛ-cocone  _ )
  --     ≤⨟ smax-lim2L _ _) ≤⨟ smax-swap4)
  --   , (≤ₛ-limiting   λ k → _ ⊓Size _ By hide
  --                  ≤⨟ ≤ₛ-cocone  _
  --                  ≤⨟ ≤ₛ-cocone  _)
  --     ≤⨟ smax-lim2L _ _
  --   , descMeetSize D1 D2 lto _ _ , tt)
  -- ≤⨟ smax*-swap)
  --   ≤⨟ smax-sucMono ≤ₛ-refl
...
--   = ≤ₛ-sucMono (smax-mono ( (_ ⊓Size _ By hide) ) ( (extFinLim _ _ ? ≤⨟ smax-FinLim2 _ _ ) ) ≤⨟ smax-swap4)
--   ≤⨟ smax-sucMono (≤ₛ-refl )
