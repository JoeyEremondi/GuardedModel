...
headDecEq Hℕ HΠ = no (λ ())
headDecEq Hℕ HΣ = no (λ ())
headDecEq Hℕ H≅ = no (λ ())
headDecEq Hℕ Hℕ = yes reflp
headDecEq Hℕ H𝟘 = no (λ ())
headDecEq Hℕ H𝟙 = no (λ ())
headDecEq Hℕ HType = no (λ ())
headDecEq Hℕ HCumul = no (λ ())
headDecEq Hℕ (HCtor x) = no (λ ())
headDecEq HΠ Hℕ = no (λ ())
headDecEq HΣ Hℕ = no (λ ())
headDecEq H≅ Hℕ = no (λ ())
headDecEq H𝟘 Hℕ = no (λ ())
headDecEq H𝟙 Hℕ = no (λ ())
headDecEq HType Hℕ = no (λ ())
headDecEq HCumul Hℕ = no (λ ())
headDecEq (HCtor x) Hℕ = no (λ ())
