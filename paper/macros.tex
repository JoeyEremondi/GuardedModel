...
\newcommand{\app}{\targetstyle{\circledast}}
\newcommand{\lob}{\textit{l\"{o}b}\xspace}
\newcommand{\Lob}{L\"{o}b\xspace}
...
\newcommand{\aCode}{\targetstyle{\bC^{A}}}
\newcommand{\aEl}{\targetstyle{\mathbf{El}^A}}
\newcommand{\eCode}{\targetstyle{\mathbf{Code}^{E}}}
\newcommand{\eEl}{\targetstyle{\mathbf{El}^{E}}}
