...
\newcommand{\targetstyle}{\surfstyle}
...
\newcommand{\targetdesc}{\surfstyle{\textit{green, italic serif font}}\xspace}
...
\NewDocumentCommand{\rType}{m}{{\surfstyle{\mathcal{U}_{#1}}}}
...
\newcommand{\guarded}{\r{\triangleright}}
\newcommand{\tguarded}{\r{\blacktriangleright}}
...
\newcommand\blackoline[1]{\colorlet{temp}{.}\color{black}\overline{\color{temp}#1}\color{temp}}
...
\newcommand{\bN}{\mymathbb{N}}
\newcommand{\bZero}{\mymathbb{0}}
\newcommand{\bOne}{\mymathbb{1}}
\newcommand{\bB}{\mymathbb{B}}
\newcommand{\bC}{\mymathbb{C}}
\newcommand{\bV}{\mymathbb{V}}
\newcommand{\bU}{\mymathbb{U}}
...
\newcommand{\CIC}{Calculus of Inductive Constructions}
